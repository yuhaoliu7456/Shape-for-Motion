...
local_ckpt_path = "/mnt/hwfile/3dobject_aigc/liuyuhao/checkpoints/sv4d.safetensors"
...
local_dir = "checkpoints"
local_ckpt_path = os.path.join(local_dir, filename)
local_ckpt_path = "/mnt/hwfile/3dobject_aigc/liuyuhao/checkpoints/sv3d_p.safetensors"
