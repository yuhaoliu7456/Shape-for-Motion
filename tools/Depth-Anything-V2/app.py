...
state_dict = torch.load(f'/apdcephfs_jn/share_302245012/yuhaliu/Weights/depth_anything_v2_{encoder}.pth', map_location="cpu")
...
if __name__ == '__main__':
    demo.queue().launch(server_name="29.76.20.153",
                        server_port=443,
                        auth=("lyh", "lyh"))