...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        # for Sv4d dataset
        self.views_index = None
        self.views_num = 1
        self.time_index = None
        self.time_num = 1
        self.train_json = "camera_sv3d.json"
        self.test_json = "camera_sv3d.json"
        self.time_indexs_that_use_novel_views = None
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.resume_iter = 0
        self.sample_interval_novel_views = 1000000000000

        self.depth_loss_weight = 0.0
        self.novel_views_depth_loss_weight=0.0
        self.novel_views_mask_loss_weight=0.0
        self.novel_views_mesh_img_loss_weight=0.0
        self.novel_views_gs_loss_weight=1.0
