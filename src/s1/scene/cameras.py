...
import numpy as np
from s1.utils.graphics_utils import getWorld2View2, getProjectionMatrix, getProjectionMatrix_from_K


class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask, gt_depth, image_name,image_path, orig_transform, uid, orig_img=None,
                 trans=np.array([0.0, 0.0, 0.0]), scale=1.0, data_device="cuda", fid=None, depth=None,
                 K=None, W=None, H=None, mesh_verts=None, mesh_faces=None, vid=None, tid=None):
