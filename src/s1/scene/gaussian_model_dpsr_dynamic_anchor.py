...
from s1.utils.general_utils import build_covariance_from_scaling_rotation, gaussian_3d_coeff
from s1.utils.system_utils import searchForMaxIteration
from s1.utils.mesh_utils import get_opacity_field_from_gaussians

from diso import DiffDMC, DiffMC
from s1.nvdiffrast_utils.dpsr import DPSR
...
class GaussianModelDPSRDynamicAnchor:
    ...
    def __init__(self, sh_degree: int, grid_res: int, density_thres: float, dpsr_sig: float):
        ...
        print(grid_res, "grid_res", self.dpsr_sig, "dpsr_sig")
